$(document).ready(function() {
	...
	function getThumbs(page,s) {
			...
			client.onreadystatechange= function(){
				if (client.readyState == 4 && client.status == 200) {//done and successful http responce
					//call function with responce 
					var str = client.responseText;
					if (str.indexOf("jsonFlickrApi")===0){
							eval(str); //retriving as jason format and returning in java obj (returning jason flicker api with jason payload)
						};
				}
			};
